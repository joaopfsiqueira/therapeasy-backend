...
import { IController } from './utils/interfaces/controller.interface' //pegando tudo o que está implementado dentro do IController, que é a interface que é implementada em cada classe de controller
