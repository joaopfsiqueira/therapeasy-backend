...
import { Answer } from './domain/questions/answer/answer.entity'
...
class AppDataSource {
    ...
    constructor() {
        this.DataSource = new DataSource({
            ...
            synchronize: true,
            logging: false,
            entities: [Person, User, Questionnaire, Topic, Doctor, Patient, Question, OptionAnswer, PatientTopic, QuestionTopic, Answer],
            migrations: [],
            subscribers: [],
        })
    }
